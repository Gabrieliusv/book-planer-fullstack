...
import { getCharacters, deleteCharacter } from '../redux/actions/characterActions';
import { toggleAddCharacter, toggleTrash, openDeleteNotification, openEditCharacter, openCharacter, closeCharacter } from '../redux/actions/navigationActions';
...
function CustomNav(props) {
    const { container, toggleAddCharacter, toggleTrash, deleteCharacter, getCharacters, openDeleteNotification, openEditCharacter, openCharacter, closeCharacter } = props;
    const { charactersInfo } = props.characters;
    const { editCharacterWindow, deleteNotificationWindow, trashWindow, addCharacterWindow, characterInfoWindow, charactersOverviewWindow } = props.navigation;
        ...
        <div>
            ...
            <List>
                {charactersInfo === null ? null : charactersInfo.map((i, index) => (
                    <ListItem button key={i.id} onClick={() => handleSelectChar(i.id)}>
                        <ListItemText primary={i.name} className={classes.listItem} />
                        {i.id !== characterInfoWindow ? null :
                            <>
                                <Tooltip title="Edit">
                                    <IconButton aria-label="Edit" onClick={() => handleOpenEditCharacter(i, index)}>
                                        <Icon>edit_icon</Icon>
                                    </IconButton>
                                </Tooltip>
