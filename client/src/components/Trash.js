...
import { Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Checkbox, Divider, List, Card, CardHeader, ListItem, ListItemText, ListItemIcon, useMediaQuery } from '@material-ui/core';
import PropTypes from 'prop-types';
import { connect } from 'react-redux';
import { toggleTrash } from '../redux/actions/navigationActions'
import { deleteTrash, restoreCharacter } from '../redux/actions/characterActions'
    ...
    const customList = (title, items) => (
        <Card>
            ...
            <List className={classes.list} dense>
                {items.map(value => (
                    <ListItem key={inTrash.indexOf(value)} button onClick={() => handleToggle(value)}>
                        <ListItemIcon>
...
export default connect(mapStateToProps, { toggleTrash, deleteTrash, restoreCharacter })(Trash);