import { TOGGLE_ADDCHARACTER, TOGGLE_TRASH, OPEN_DELETE_NOTIFICATION, CLOSE_DELETE_NOTIFICATION, OPEN_EDIT_CHARACTER, CLOSE_EDIT_CHARACTER, OPEN_CHARACTER, CLOSE_CHARACTER, OPEN_CHARACTERS_OVERVIEW, OPEN_EDIT_STORYLINE, CLOSE_EDIT_STORYLINE } from '../actions/types';
...
export default function (state = initialState, action) {
    switch (action.type) {
        ...
        case OPEN_EDIT_STORYLINE:
            return {
                ...state,
                editStoryWindow: { open: true, character: action.payload, index: action.index }
            }
